...
public class VolumeControllerDialogFragment extends AppCompatDialogFragment
        implements HostConnectionObserver.ApplicationEventsObserver,
        OnHardwareVolumeKeyPressedCallback {

    private static final String TAG = LogUtils.makeLogTag(VolumeControllerDialogFragment.class);
    ...
    private long lastHardwareVolumeKeyEvent;
    private Handler callbackHandler = new Handler();
    private Runnable dismissDialog = new Runnable() {
        @Override
        public void run() {
            long timeSinceLastEvent = System.currentTimeMillis() - lastHardwareVolumeKeyEvent;
    ...
    public void show(FragmentManager manager, String tag) {
        ...
        lastHardwareVolumeKeyEvent = System.currentTimeMillis();
