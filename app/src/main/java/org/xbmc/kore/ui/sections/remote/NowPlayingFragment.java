...
public class NowPlayingFragment extends Fragment
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        binding.volumeLevelIndicator.setOnVolumeChangeListener(volume -> new Application.SetVolume(volume).execute(hostManager.getConnection(),
...
//        mediaPanel.setClipToPadding(false);
    ...
    public void playerOnStop() {
        ...
        // TODO ViewBinding infoTitle/infoMessage doesnt exist
