...
public class VolumeControllerDialogFragmentListener extends AppCompatDialogFragment
    ...
    private VolumeControllerDialogBinding binding;
    ...
    private View.OnClickListener onMuteToggleOnClickListener = v -> {
        cancelDismissDialog();
    ...
    public void onResume() {
        super.onResume();
        Objects.requireNonNull(getDialog()).setOnKeyListener((android.content.DialogInterface dialog, int keyCode,
    ...
    private void setListeners() {
        ...
        binding.vcdVolumeLevelIndicator.setOnVolumeChangeListener((int volume) -> {
            cancelDismissDialog();
