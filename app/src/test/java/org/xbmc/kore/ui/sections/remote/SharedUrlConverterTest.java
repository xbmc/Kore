...
public class SharedUrlConverterTest {
    ...
    public void youtube_short_url() {
        assertEquals(YT_PLUGIN_PREFIX + YT_ID, ShareHandlingFragment.DECLARED_AUTHORITIES
                .urlFrom("https://youtu.be/" + YT_ID));
    }
    ...
    public void vimeo_url() {
        ...
        assertEquals(expected, ShareHandlingFragment.DECLARED_AUTHORITIES
    ...
    public void vimeo_id_is_the_first_numeric_segment() {
        ...
        assertNull(ShareHandlingFragment.DECLARED_AUTHORITIES.urlFrom("http://vimeo.com/a/b/c?path=/" + VM_ID));
    }
}